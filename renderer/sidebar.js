export function getEls() {
  return {
    ...
    chatHeaderSearchBtn: document.getElementById('chat-header-search-btn'),
    chatHeaderSearchPanel: document.getElementById('chat-header-search-panel'),
    chatHeaderSearchInput: document.getElementById('chat-header-search-input'),
